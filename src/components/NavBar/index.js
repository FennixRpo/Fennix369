    ...
    <>
      <nav className="bg-black text-white shadow flex justify-between">
        ...
        <div className="container px-5 gap-12 flex items-center justify-center p-6 mx-auto text-white capitalize ">
          ...
          <a href="/portafolio" className="border-b-2 px-6 border-transparent hover:text-gray-50 transition-colors duration-300 transform  mx-1.5 sm:mx-6">Portafolio</a>

          <a href="/servicios" className="border-b-2 px-6 border-transparent hover:text-gray-50 transition-colors duration-300 transform mx-1.5 sm:mx-6">Servicios</a>

          <a href="/contacto" className="border-b-2 px-6 border-transparent hover:text-gray-50 transition-colors duration-300 transform  mx-1.5 sm:mx-6">Contactenos</a>

          <a href="/" className="border-b-2 border-transparent hover:text-gray-800 transition-colors duration-300 transform  mx-1.5 sm:mx-6">
