              ...
              <div className='flex flex-wrap -m-6'>
                <div className='w-full md:w-1/2 lg:w-1/3 p-6'>
                  <div className='p-16 bg-gray-600 rounded-lg'>
                    ...
                    <p className='text-lg text-gray-200'>
                      Diseño que cautiva. Transformamos ideas en imágenes
                      impactantes. ¡Destaca con nuestro servicio de diseño
                      gráfico profesional y creativo!
                    </p>
                  </div>
                </div>
                <div className='w-full md:w-1/2 lg:w-1/3 p-6'>
                  <div className='p-16 bg-gray-600 rounded-lg'>
                    ...
                    <p className='text-lg text-gray-200'>
                      Impresión que marca la diferencia. Desde banners hasta
                      vallas, ofrecemos calidad y precisión en gran formato para
                      destacar tu marca con impacto visual.
                    </p>
                  </div>
                </div>
                <div className='w-full md:w-1/2 lg:w-1/3 p-6'>
                  <div className='p-16 bg-gray-600 rounded-lg'>
                    ...
                    <p className='text-lg text-gray-200'>
                      Guiando tu camino con claridad y estilo. Nuestra
                      señalética ofrece soluciones visuales efectivas para
                      orientarte y destacar tu espacio con elegancia y
                      funcionalidad.
                    </p>
                  </div>
                </div>
                <div className='w-full md:w-1/2 lg:w-1/3 p-6'>
                  <div className='p-16 bg-gray-600 rounded-lg'>
                    ...
                    <p className='text-lg text-gray-200'>
                      Transforma espacios con arte vibrante y personalizado.
                      Nuestros murales y decoraciones añaden vida y estilo único
                      a cualquier ambiente, inspirando creatividad y admiración.
                    </p>
                  </div>
                </div>
                <div className='w-full md:w-1/2 lg:w-1/3 p-6'>
                  <div className='p-16 bg-gray-600 rounded-lg'>
                    ...
                    <p className='text-lg text-gray-200'>
                      Diseño web que cautiva y convierte. Creamos experiencias
                      digitales excepcionales que destacan tu marca y cautivan a
                      tu audiencia, impulsando el éxito en línea
                    </p>
                  </div>
                </div>
                <div className='w-full md:w-1/2 lg:w-1/3 p-6'>
                  <div className='p-16 bg-gray-600 rounded-lg'>
                    ...
                    <p className='text-lg text-gray-200'>
                      Sublimación que refleja tu estilo único. Transformamos tus
                      ideas en productos personalizados de alta calidad, llenos
                      de color y significado. ¡Deja tu marca con nosotros!
                    </p>
                  </div>
                </div>
              </div>
